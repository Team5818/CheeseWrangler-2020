...
def main():
    ...
    while True:
        ...
        img = cv2.flip(img, -1)
        img = img[int(img.shape[0] * 0.35):, :img.shape[1]]
...
def create_trackbars():
    ...
    create_single_trackbar('Red Min', 37, 255)
    create_single_trackbar('Green Min', 131, 255)
    create_single_trackbar('Blue Min', 200, 255)
    create_single_trackbar('Red Max', 255, 255)
    create_single_trackbar('Green Max', 255, 255)
    create_single_trackbar('Blue Max', 211, 255)
    
    create_single_trackbar('Erode', 0, 40)
    create_single_trackbar('Dilate', 7, 40)
    create_single_trackbar('Ratio Min', 0, 10)
    create_single_trackbar('Ratio Max', 2, 10)
    create_single_trackbar('Fill %', 0, 100)
    create_single_trackbar('Radius Min', 5, 200)
    create_single_trackbar('Radius Max', 25, 200)
